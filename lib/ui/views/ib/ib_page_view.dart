...
class _IbPageViewState extends State<IbPageView> {
  ...
  final IbfloatingBtnController ibfloatingBtnController = Get.put(IbfloatingBtnController());
      ...
      buttons.add(        
        Obx(() {
          return AnimatedOpacity(
            ...
            opacity: ibfloatingBtnController.isFloatingBtnVisible.value ? 1.0 : 0.0,
