...
/// Home page component for the Interactive Book
/// Displays the main landing page with hero section, features, and getting started guide
class IbHomePage extends StatelessWidget {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildHeroSection(context, homeData),
          
          const SizedBox(height: 24),

          // Content Box with all sections
          _buildContentBox(context, homeData),
  ...
  Widget _buildHeroSection(BuildContext context, NewIbHomeData homeData) {
    return Container(
  ...
  Widget _buildContentBox(BuildContext context, NewIbHomeData homeData) {
    return Container(
