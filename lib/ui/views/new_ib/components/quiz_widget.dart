...
class _QuizWidgetState extends State<QuizWidget> {
  ...
  Widget _buildQuestion(BuildContext context, int questionIndex, QuizQuestion question) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            spacing: 8,
            runSpacing: 8,
            children: question.answers.asMap().entries.map((answerEntry) {
              ...
              if (isSelected) {
                if (isCorrect) {
                  backgroundColor = const Color(0xFF5cd65c); // Green for correct
                  textColor = Colors.white;
                  borderColor = const Color(0xFF5cd65c);
                } else {
                  backgroundColor = const Color(0xFFff6666); // Red for incorrect
                  textColor = Colors.white;
              ...
              return InkWell(
                onTap: () => _selectAnswer(questionIndex, answerIndex, isCorrect),
