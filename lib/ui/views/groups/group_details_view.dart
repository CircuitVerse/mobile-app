...
class _GroupDetailsViewState extends State<GroupDetailsView> {
  ...
  Future<void> onAddGroupMemberPressed(BuildContext context) async {
    if (Validators.validateAndSaveForm(_formKey)) {
      ...
      if (_model.isSuccess(_model.addGroupMembersKey) &&
          _model.addedMembersSuccessMessage.isNotEmpty) {
        SnackBarUtils.showDark(
          'Group Members Added',
          _model.addedMembersSuccessMessage,
        );
      } else if (_model.isError(_model.addGroupMembersKey)) {
        SnackBarUtils.showDark(
          'Error',
          _model.errorMessageFor(_model.addGroupMembersKey),
        );
      }
    }
  ...
  Future<void> onDeleteGroupMemberPressed(String groupMemberId) async {
    ...
    if (_dialogResponse.confirmed) {
      ...
      if (_model.isSuccess(_model.deleteGroupMemberKey)) {
        SnackBarUtils.showDark(
          'Group Member Removed',
          'Successfully removed group member.',
        );
      } else if (_model.isError(_model.deleteGroupMemberKey)) {
        SnackBarUtils.showDark(
          'Error',
          _model.errorMessageFor(_model.deleteGroupMemberKey),
        );
      }
    }
  }
  ...
  Future<void> onDeleteAssignmentPressed(String assignmentId) async {
    ...
    if (_dialogResponse.confirmed) {
      ...
      if (_model.isSuccess(_model.deleteAssignmentKey)) {
        SnackBarUtils.showDark(
          'Assignment Deleted',
          'The assignment was successfully deleted.',
        );
      } else if (_model.isError(_model.deleteAssignmentKey)) {
        SnackBarUtils.showDark(
          'Error',
          _model.errorMessageFor(_model.deleteAssignmentKey),
        );
      }
    }
  }
  ...
  Future<void> onReopenAssignmentPressed(String assignmentId) async {
    ...
    if (_dialogResponse.confirmed) {
      ...
      if (_model.isSuccess(_model.reopenAssignmentKey)) {
        SnackBarUtils.showDark(
          'Assignment Reopened',
          'The assignment is reopened now.',
        );
      } else if (_model.isError(_model.reopenAssignmentKey)) {
        SnackBarUtils.showDark(
          'Error',
          _model.errorMessageFor(_model.reopenAssignmentKey),
        );
      }
    }
  }
  ...
  Future<void> onStartAssignmentPressed(String assignmentId) async {
    ...
    if (_dialogResponse.confirmed) {
      ...
      if (_model.isSuccess(_model.startAssignmentKey)) {
        SnackBarUtils.showDark(
          'Project Created',
        ...
        SnackBarUtils.showDark(
          'Error',
          _model.errorMessageFor(_model.startAssignmentKey),
        );
      }
    }
  }
    ...
    return BaseView<GroupDetailsViewModel>(
      ...
      builder: (context, model, child) => Scaffold(
        ...
        body: Builder(builder: (context) {
          ...
          if (_model.isSuccess(_model.fetchGroupDetailsKey)) {
