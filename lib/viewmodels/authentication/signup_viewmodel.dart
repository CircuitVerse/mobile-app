...
class SignupViewModel extends BaseModel {
  ...
  Future<void> signup(String name, String email, String password) async {
    setStateFor(signupKey, ViewState.Busy);
    try {
      ...
      setStateFor(signupKey, ViewState.Success);
    } on Failure catch (f) {
      setStateFor(signupKey, ViewState.Error);
      setErrorMessageFor(signupKey, f.message);
    }
  }
}
