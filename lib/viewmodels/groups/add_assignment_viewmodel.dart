...
class AddAssignmentViewModel extends BaseModel {
  // ViewState Keys
  final String addASSIGNMENT = 'add_assignment';
  ...
  Future addAssignment(
    ...
    setStateFor(addASSIGNMENT, ViewState.Busy);
    try {
      // deadline format..
      ...
      setStateFor(addASSIGNMENT, ViewState.Success);
    } on Failure catch (f) {
      setStateFor(addASSIGNMENT, ViewState.Error);
      setErrorMessageFor(addASSIGNMENT, f.message);
    }
  }
}
