  ...
  group('FeaturedProjectsViewModelTest -', () {
    ...
    group('fetchFeaturedProjects -', () {
      test('When first time fetched & service returns success response',
        ...
        expect(
            _model.stateFor(_model.fetchFEATUREDPROJECTS), ViewState.Success);
      ...
      test('When service returns error response', () async {
        ...
        expect(_model.stateFor(_model.fetchFEATUREDPROJECTS), ViewState.Error);
        expect(_model.errorMessageFor(_model.fetchFEATUREDPROJECTS),
            'Some Error Occurred!');
      });
    });
  });
