  ...
  group('AddAssignmentViewModelTest -', () {
    ...
    group('addAssignment -', () {
      test('When called & service returns success response', () async {
        ...
        expect(_model.stateFor(_model.addAssignmentKey), ViewState.Success);
      ...
      test('When called & service returns error', () async {
        ...
        expect(_model.stateFor(_model.addAssignmentKey), ViewState.Error);
        expect(_model.errorMessageFor(_model.addAssignmentKey),
            'Some Error Occurred!');
      });
    });
  });
