  ...
  group('EditProfileViewModelTest -', () {
    ...
    group('updateProfile -', () {
      test('When called & service returns success response', () async {
        ...
        expect(_model.stateFor(_model.updateProfileKey), ViewState.Success);
      ...
      test('When called & service returns error', () async {
        ...
        expect(_model.stateFor(_model.updateProfileKey), ViewState.Error);
        expect(_model.errorMessageFor(_model.updateProfileKey),
            'Some Error Occurred!');
