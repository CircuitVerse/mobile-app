    ...
    group('fetchUserFavourites -', () {
      test(
        ...
        () async {
          ...
          when(
            _mockProjectsApi.getUserFavourites('1'),
          ...
          expect(
            _model.stateFor(_model.FETCH_USER_FAVOURITES),
            ViewState.Success,
          );
      ...
      test(
        ...
        () async {
          var _mockProjectsApi = getAndRegisterProjectsApiMock();
          when(
            _mockProjectsApi.getUserFavourites('1', page: 2),
          ).thenAnswer((_) => Future.value(_projects));
      ...
      test('When service returns error response', () async {
        ...
        expect(
          _model.errorMessageFor(_model.FETCH_USER_FAVOURITES),
          'Some Error Occurred!',
        );
      });
    });
